...
byte RGBredPin  = 5;  // RS 276-0028  1-Red 2-Common annode 3-blue  4-green
byte RGBgreenPin= 9; // Adafruit 848 1-Red 2-Common annode 3-green 4-blue
byte RGBbluePin = 6;
byte touchPin   = A3;
byte analogPin=A5;	
int analogValue;
